...
Lucky Horseshoe - $2 - +4 mult
Snake Eyes - $5 - scored 1s give +3 mult
...
Trail Markers - $3 - if played hand contains straight 3 +6 mult
...
Dust Path - $3 - if played hand contains straight 3 +50 miles
...
Gold Pan - $4 - 1 in 2 chance to give $2 when an enhanced dice scores
Trail Journal - $5 - adds the number of times the hand has been played this trip as mult
Dry Spell - $6 - +1 mult per hand played without scoring a 6
Mapmaker’s Kit - $5 - 1 in 4 chance to upgrade trail knowledge of hand type played
...
Hellfire Round - $6 - if first hand of round is a single enhanced 6, destroy it and gain a "Frontier Encounter" card
...
Wanted Poster - $4 - earn 4 dollars if hand is [hand]. Changes each leg of journey
...
Loaded Coin - $4 - doubles all listed probabilities
